...
class ShowGaleria extends Component
{
    use WithFileUploads;
    use LivewireAlert;
    use WithPagination;
    public $nombreCrud = 'Galeria';
    ...
    public function render()
    {
        ...
        $buscar = $this->buscar;
        $consulta = Galeria::query()
        ->when(!empty($buscar), function ($query) use ($buscar) {
            return $query->where('nombre', 'LIKE', '%' . $buscar . '%');
        })
        ->get();

        return view('livewire.show-galeria', [
            'consulta' => $consulta,
        ]);
    }
    ...
    public function guardar()
    {
        ...
        $beneficios = Galeria::create($validatedData);
    ...
    {
        $this->consultaVer = Galeria::find($id);
    ...
    {
        Galeria::whereIn('_id', $this->eliminarItem)->delete();
