                ...
                <x-table>
                    <x-slot name="head">
                        <x-tr class="font-semibold">
                            ...
                            <th class="py-6">URL1</th>
                            <th class="py-6">URL2</th>
                    ...
                    <x-slot name="bodytable">
                        ...
                        <x-tr x-data="{ openOption: false }">
                            ...
                            <x-td wire:click="ver('{{ $item->id }}')">{{ $item->url1 ?? '' }}</x-td>
                            <x-td wire:click="ver('{{ $item->id }}')">{{ $item->url2 ?? '' }}</x-td>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="titulo" label="titulo" name="titulo" id="titulo" type="text"
                    value="" placeholder="Titulo" maxlength="200" />

                <x-input-with-label wire="descripcion" label="Descripción" name="descripcion" id="descripcion" type="text"
                    value="" placeholder="Descripción" maxlength="200" />

                <x-input-with-label wire="url1" label="Url1" name="url1" id="url1" type="text"
                    value="" placeholder="Url" maxlength="200" />

                <x-input-with-label wire="url2" label="Url2" name="url2" id="url2" type="text"
                    value="" placeholder="Url" maxlength="200" />
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="titulo" label="titulo" name="titulo" id="titulo" type="text"
                     disabled value="" placeholder="titulo" maxlength="40" />

                    <x-input-with-label wire="descripcion" label="Descripción" name="descripcion" id="descripcion" type="text"
                    disabled value="" placeholder="Descripción" maxlength="40" />

                    <x-input-with-label wire="url1" label="Url1" name="url1" id="url1" type="text"
                    disabled value="" placeholder="Url" maxlength="40" />
