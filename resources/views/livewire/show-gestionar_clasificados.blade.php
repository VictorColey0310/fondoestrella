    ...
    <x-contenedor>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="titulo" label="Titulo" name="titulo" id="titulo" type="text"
                    ...
                    <div class="mb-4">
                        <label for="descripcion" class="block text-sm font-medium leading-5 text-gray-700">Descripción</label>
                        <textarea id="descripcion" name="descripcion" wire:model="descripcion" placeholder="Descripción" class="form-textarea mt-1 block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-gray-300 rounded-md"></textarea>
                    </div>
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                ...
                disabled type="textarea" placeholder="Descripcion" maxlength="0" value=""/>
