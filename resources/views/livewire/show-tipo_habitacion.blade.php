<div x-data="{
    ...
    <x-contenedor>
        ...
        <x-tabla-crud>
            <x-slot name="titulo"> Tipo habitacion </x-slot>
            <x-slot name="subtitulo"> Descripcion de Tipo habitacion </x-slot>
            ...
            <x-slot name="tabla">
                ...
                <x-table>
                    ...
                    @forelse ($consultaTipoHabitacion as $item)
        ...
        <x-modal-crud x-show="nuevo">
            <x-slot name="titulo"> Crear Tipo habitacion </x-slot>
        ...
        <x-modal-crud x-cloak x-show="editar">
            <x-slot name="titulo"> Editar Tipo habitacion </x-slot>
        ...
        <x-modal-crud x-show="ver">
            <x-slot name="titulo"> Ver Tipo habitacion</x-slot>
