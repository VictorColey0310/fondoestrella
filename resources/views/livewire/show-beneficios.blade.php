        ...
        <x-modal-crud x-cloak x-show="editar">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="url" label="url" name="url" id="url" type="text" placeholder="Url" maxlength="40" value=""/>

                    <div>
                        <img src="{{asset($imagen)}}" alt="">
                    </div>

                    <x-input-file wire="imagen1" label="imagen" name="imagen1" id="imagen1" type="file" placeholder="imagen" maxlength="200" value="" />
                        <div class="mb-2">
                            @if ($imagen1)
                                {{-- <img src="{{ $imagen->temporaryUrl() }}" alt="imagen" class="w-32 h-32 border mx-8  rounded-lg object-cover"> --}}
                                <div class="w-32 h-32 border mx-8  rounded-lg"></div>
