    ...
    <x-contenedor>
                ...
                <x-table>
                    <x-slot name="head">
                        <x-tr class="font-semibold">
                            <th class="py-6"></th>
                            <th class="py-6">Grupo De Convenio</th>
                    ...
                    <x-slot name="bodytable">
                        ...
                        @foreach ($consulta as $item)
                            <x-tr x-data="{ openOption: false }">
                                ...
                                <x-td
                                    wire:click="ver('{{ $item->id }}')">{{ $item->grupo_convenios->titulo ?? '' }}</x-td>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-select wire="grupo_id" label="Grupo" name="grupo" id="grupo" value="">
                    <x-slot name="option">
                        <option>Seleccionar</option>
                        @foreach ($consulta_grupo as $item)
                ...
                <x-input-with-label wire="descripcion" label="Descripcion" name="descripcion" id="descripcion"
                    type="text" value="" placeholder="descripcion" maxlength="300" />
        ...
        <x-modal-crud x-cloak x-show="editar">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="descripcion" label="descripcion" name="descripcion" id="descripcion"
                        type="text" placeholder="" maxlength="300" value="" />
        ...
        <x-modal-crud x-show="ver">
            ...
            @if (!empty($consultaVer))
                <x-slot name="campos">
                    ...
                    <x-input-with-label wire="grupo_id" label="Grupo" name="grupo" id="grupo" type="text"
                        disabled placeholder="Grupo" maxlength="0" value="" />


                    <x-input-with-label wire="nombre" label="nombre" name="nombre" id="nombre" type="text"
                        disabled placeholder="" maxlength="0" value="" />

                    <x-input-with-label wire="descripcion" label="descripcion" name="descripcion" id="titulo"
