    ...
    <x-contenedor>
        ...
        <x-modal-crud x-show="nuevo">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="nombre" label="nombre" name="nombre" id="nombre" type="text"
                    value="" placeholder="Nombre" maxlength="500" />

                <x-input-with-label wire="url" label="url" name="url" id="url" type="text"
                    value="" placeholder="Url" maxlength="500" />
        ...
        <x-modal-crud x-cloak x-show="editar">
            ...
            <x-slot name="campos">
                ...
                <x-input-with-label wire="nombre" label="Nombre" name="nombre" id="nombre" type="text" placeholder="" maxlength="40" value=""/>

                <x-input-with-label wire="url" label="url" name="url" id="url" type="text" placeholder="Url" maxlength="500" value=""/>
